...
if(deg != medpot & tent <= 1 & inter > 10 & inter > 4){
...
if((medpot-posi) < (inter*0.60)  & (millis()-tempo1) > 30){
   tempo1 = millis();
  if(valpwm < 255){
    valpwm++;
     }
...
if((medpot-posi) > (inter*0.40) & (millis()-tempo1) > 5){
  tempo1 = millis();
  if(valpwm > 55){
   valpwm--;
     }
...
//ajuste do valor da pwm - aceleração
if((posi-medpot) < (inter*0.60)  & (millis()-tempo1) > 30){
   tempo1 = millis();
  if(valpwm < 255){
    valpwm++;
     }
...
//ajuste do valor da pwm - desacelaração
if((posi-medpot) > (inter*0.40) & (millis()-tempo1) > 5){
  tempo1 = millis();
  if(valpwm > 55){
   valpwm--;
     }
...
if(deg != medpot & tent1 <= 1 & inter <= 10 & inter > 4){
